	...
	/**
	   ...
	   */    
        ...
        /**
		   ...
		   * @return x,y
		   */  
        this.getLocation = function(id,date){
            var value = "";
            if (navigator.geolocation) { // GPS를 지원하면
                navigator.geolocation.getCurrentPosition(function(position) {
                  //console.log("position : ", position)
                  //console.log('위도 x : '+position.coords.latitude + ' , 경도 y : ' + position.coords.longitude);
                  getLoadName(id,date,position.coords.latitude, position.coords.longitude);
                }, function(error) {
                  console.error(error);
                }, {
